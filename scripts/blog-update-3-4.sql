-- ==========================================
-- blog-update-3-4.sql
-- UPDATE (overwrite) existing blog posts 3 and 4
-- ==========================================

UPDATE blog_posts SET
  title = 'AI Video Editing Tools Compared: Descript vs CapCut vs Runway (2026)',
  excerpt = 'Descript, CapCut, and Runway each solve a different editing problem. Here''s how they compare on AI features, price, and the use cases where each one wins.',
  meta_description = 'Compare Descript vs CapCut vs Runway in 2026. Features, pricing, and which AI video editor is best for YouTubers, faceless channels, and content creators.',
  category = 'AI Video',
...
UPDATE blog_posts SET
  title = 'How to Automate Social Media Content with AI: Step-by-Step Guide',
  excerpt = 'Posting consistently on 3-5 platforms while also making YouTube videos isn''t humanly sustainable. Here''s how to automate 80% of your social media content workflow with AI.',
  meta_description = 'How to automate social media content with AI in 2026. Step-by-step guide covering content calendars, graphics, captions, scheduling, and repurposing tools.',
...
<h2>Step 5: Schedule Everything with n8n or Make</h2>
...
WHERE slug = 'how-to-automate-social-media-with-ai';
