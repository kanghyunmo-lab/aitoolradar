...
// Claude Code Requirement 1: noindex 필수
export const metadata: Metadata = {
    title: "Preview - AIToolRadar Redesign",
    robots: {
        index: false,
        follow: false,
    },
      ...
      */}
            <section className="relative overflow-hidden px-4 py-24 text-center sm:py-32">
                ...
                <div className="relative z-10 mx-auto max-w-5xl">
                    {/* Trust Badge / Stat Badge (Claude Code Requirement 4) */}
        ...
        (Claude Code Requirement 3: Above Categories)
        ========================================
      */}
