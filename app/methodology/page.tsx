  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      <nav className="mb-8 text-sm text-gray-400">
        ...
        {" / "}
        <span className="text-white">Our Methodology</span>
      </nav>

      <h1 className="text-3xl font-extrabold text-white">Our Rating Methodology</h1>
      ...
      <div className="mt-10 space-y-8 text-gray-300 leading-relaxed">
          ...
          <div className="space-y-5">
            <div className="rounded-lg border border-gray-800 p-5">
              <div className="flex items-center gap-3">
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-500/20 text-sm font-bold text-blue-400">1</span>
                <h3 className="font-semibold text-white">Features & Capabilities (30%)</h3>
              </div>
            ...
            <div className="rounded-lg border border-gray-800 p-5">
              <div className="flex items-center gap-3">
                ...
                <h3 className="font-semibold text-white">Value for Money (25%)</h3>
              </div>
              <p className="mt-2 text-sm">
            ...
            <div className="rounded-lg border border-gray-800 p-5">
              <div className="flex items-center gap-3">
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-500/20 text-sm font-bold text-blue-400">3</span>
                <h3 className="font-semibold text-white">Ease of Use (20%)</h3>
              </div>
              <p className="mt-2 text-sm">
            ...
            <div className="rounded-lg border border-gray-800 p-5">
              <div className="flex items-center gap-3">
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-500/20 text-sm font-bold text-blue-400">4</span>
                <h3 className="font-semibold text-white">Reliability & Support (15%)</h3>
              </div>
              <p className="mt-2 text-sm">
            ...
            <div className="rounded-lg border border-gray-800 p-5">
              <div className="flex items-center gap-3">
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-500/20 text-sm font-bold text-blue-400">5</span>
                <h3 className="font-semibold text-white">Integrations & Ecosystem (10%)</h3>
              </div>
              <p className="mt-2 text-sm">
        ...
        <section>
          <h2 className="text-xl font-bold text-white mb-3">Rating Scale</h2>
          <div className="overflow-hidden rounded-lg border border-gray-800">
            <table className="w-full text-sm">
              <thead className="bg-gray-800/50">
                <tr>
                  <th className="px-4 py-3 text-left font-semibold text-gray-300">Score</th>
              ...
              <tbody className="divide-y divide-gray-800">
                {[
                  ...
                  <tr key={score}>
                    <td className="px-4 py-3 font-medium text-white">{score}</td>
        ...
        <section>
          <h2 className="text-xl font-bold text-white mb-3">Independence & Transparency</h2>
          <p>
      ...
      <div className="mt-12 border-t border-gray-800 pt-8">
        <Link href="/" className="text-blue-600 hover:text-blue-400 text-sm font-medium">
          ← Back to AIToolRadar
        </Link>
      </div>
    </main>
